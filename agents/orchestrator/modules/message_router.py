"""Message routing module for Orchestrator (agent-local)"""
...
class MessageRouter:
    ...
    async def route_user_confirmation(self, confirmation_data: str) -> str:
        ...
        try:
            ...
            eval_agent_info = self._find_agent_by_name_or_capability("eval_agent", "eval")
    ...
    async def route_eval_question(self, question_data: str) -> str:
        ...
        try:
            ...
            cs_agent_info = self._find_agent_by_name_or_capability("customer_success", "user_interaction")
    ...
    def _find_agent_by_name_or_capability(self, name: str, capability: str) -> Dict[str, Any] | None:
        """Find agent by canonical name or by capability hint."""
        info = self.registered_agents.get(name)
        if info:
            return info
