...
from orchestrator.message_router import MessageRouter
...
class OrchestratorAgent(BaseAgent):
    ...
    def _create_orchestrator_tools(self):
        ...
        async def send_a2a_message_to_agent(target_assistant_id: str, target_port: int, message: str, thread_id: str = None) -> str:
            ...
            try:
                response = await send_a2a_message(target_assistant_id, target_port, message, thread_id)
    ...
    def build_graph(self):
        ...
        def broadcast_node(state: OrchestratorState):
            """Fan-out any inbound message to all other agents with thread and origin metadata."""
        ...
        workflow.add_edge("broadcast", "orchestrator")
