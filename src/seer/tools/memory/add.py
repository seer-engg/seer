...
class MemoryAddTool(BaseTool):
    """Store content in a specific memory bank."""

    name = "memory_add"
    description = "Store a memory in a specific memory bank."
    ...
    def get_parameters_schema(self) -> Dict[str, Any]:
        return {
            ...
            "properties": {
                ...
                "infer": {"type": "boolean", "default": True, "description": "Whether to infer related facts"},
                "metadata": {"type": "object", "additionalProperties": True, "description": "Optional metadata payload"},
            },
            "required": ["memory_bank_id", "content"],
        }
    ...
    async def execute(
        ...
        *,
        ...
        return await memory_access.add(
            arguments["memory_bank_id"],
            content,
            metadata=arguments.get("metadata"),
            infer=bool(arguments.get("infer", True)),
        )


__all__ = ["MemoryAddTool"]
