...
class MemoryDeleteTool(BaseTool):
    """Delete an existing memory from a bank."""

    name = "memory_delete"
    description = "Delete a memory from a specific memory bank."
    ...
    async def execute(
        ...
        *,
        ...
        deleted = await memory_access.delete(arguments["memory_bank_id"], arguments["memory_id"])
        return {"deleted": deleted, "memory_id": arguments["memory_id"]}


__all__ = ["MemoryDeleteTool"]
