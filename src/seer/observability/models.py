...
TIER_LIMITS_REGISTRY: dict[SubscriptionTier, TierLimits] = {
    ...
    SubscriptionTier.LITE: TierLimits(
        workflows=constants.WORKFLOWS_LITE,
        runs_monthly=constants.RUNS_MONTHLY_LITE,
        account_day_limit=constants.ACCOUNT_DAY_LIMIT_LITE,
        poll_min_interval_seconds=constants.POLL_MIN_INTERVAL_LITE,
        llm_credits_monthly=constants.LLM_CREDITS_LITE,
        llm_credits_5h=constants.LLM_CREDITS_5H_LITE,
        llm_credits_weekly=constants.LLM_CREDITS_WEEKLY_LITE,
    ),
}
