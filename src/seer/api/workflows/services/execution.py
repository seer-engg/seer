...
from seer.api.core.errors import COMPILE_PROBLEM, RUN_PROBLEM
...
async def _execute_compiled_run(
    ...
    *,
    ...
    try:
        ...
        logger.exception("UNEXPECTED: Workflow execution failed")
        await _handle_run_failure(run, user, exc, metrics)
...
async def run_saved_workflow(
    ...
    from seer.worker.tasks.workflows import execute_saved_workflow as execute_saved_workflow_task
