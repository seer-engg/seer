...
def _register_tools() -> None:
    ...
    # MCP-only modules — @mcp.tool() decorators fire on import
    import seer.mcp.tools.workflows  # noqa: F401
    import seer.mcp.tools.execution  # noqa: F401
    import seer.mcp.tools.guides  # noqa: F401
