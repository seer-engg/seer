...
1. Evaluate my agent at `https://github.com/seer-engg/buggy-coder`.
2. Evaluate the version at `https://github.com/seer-engg/buggy-coder/tree/seer/codex/20251108-125730-92e6b17/v1`.
3. Ensure the agent syncs Asana ticket updates whenever a GitHub PR merges.
