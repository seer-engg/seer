...
from shared.database.subscription_models import SubscriptionStatus, SubscriptionTier
...
def require_subscription(min_tier: SubscriptionTier = SubscriptionTier.PRO) -> Callable:
    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def wrapper(request: Request, *args, **kwargs):
            ...
            from api.subscriptions.stripe_service import (  # pylint: disable=import-outside-toplevel
