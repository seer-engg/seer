...
from api.checkpointer import checkpointer_lifespan, get_checkpointer
from api.graphs import get_available_graphs, get_compiled_graph
...
async def lifespan(app: FastAPI):
    ...
    async with checkpointer_lifespan():
        ...
        logger.info(f"📊 Available graphs: {get_available_graphs()}")
        yield
...
@app.post("/threads", response_model=ThreadResponse, tags=["Threads"])
...
@app.get("/threads/{thread_id}/state", response_model=ThreadState, tags=["Threads"])
