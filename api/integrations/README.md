...
**Registration**:
```python
from api.integrations.providers.registry import ProviderRegistry
...
from api.integrations.providers.base import IntegrationProvider
...
class MyResourceProvider(ResourceProvider):
    ...
    async def list_resources(self, user, resource_type, connection_id, **kwargs):
        ...
        # Fetch resources from API using connection.access_token
...
from api.integrations.resource_providers.registry import ResourceProviderRegistry
