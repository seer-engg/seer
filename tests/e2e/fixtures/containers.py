...
"""
Testcontainers fixtures for PostgreSQL and Redis.

Provides session-scoped containers that start once per test session,
significantly reducing test overhead while still using real infrastructure.
"""
